...
class BlockedCreator(Base):
 ...
 blocked_at: Mapped[dt.datetime] = mapped_column(DateTime, default=dt.datetime.utcnow)
...
class session_ctx:
 ...
 def __init__(self): self._ctx = async_session()
 async def __aenter__(self): return self._ctx
 async def __aexit__(self, *e): await self._ctx.close()
